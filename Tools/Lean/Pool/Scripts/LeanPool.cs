...
namespace Lean.Pool
{
	...
	public static class LeanPool
	{
		...
		public static T Spawn<T>(T prefab, Transform parent, bool worldPositionStays = false, Transform parentOfPoolPrefab = null)
			where T : Component
		{
			if (prefab == null) { Debug.LogError("Attempting to spawn a null prefab."); return null; }
			var clone = Spawn(prefab.gameObject, parent, worldPositionStays, parentOfPoolPrefab); return clone != null ? clone.GetComponent<T>() : null;
		}

		/// <summary>This allows you to spawn a prefab via Component.</summary>
		public static T Spawn<T>(T prefab, Vector3 position, Quaternion rotation, Transform parent = null, Transform parentOfPoolPrefab = null)
			where T : Component
		{
			if (prefab == null) { Debug.LogError("Attempting to spawn a null prefab."); return null; }
			var clone = Spawn(prefab.gameObject, position, rotation, parent, parentOfPoolPrefab); return clone != null ? clone.GetComponent<T>() : null;
		}

		/// <summary>This allows you to spawn a prefab via Component.</summary>
		public static T Spawn<T>(T prefab, Transform parentOfPoolPrefab = null)
			where T : Component
		{
			if (prefab == null) { Debug.LogError("Attempting to spawn a null prefab."); return null; }
			var clone = Spawn(prefab.gameObject, parentOfPoolPrefab); return clone != null ? clone.GetComponent<T>() : null;
		}

		/// <summary>This allows you to spawn a prefab via GameObject.</summary>
		public static GameObject Spawn(GameObject prefab, Transform parent, bool worldPositionStays = false, Transform parentOfPoolPrefab = null)
		{
			if (prefab == null) { Debug.LogError("Attempting to spawn a null prefab."); return null; }
			...
			return Spawn(prefab, transform.localPosition, transform.localRotation, transform.localScale, parent, false, parentOfPoolPrefab);
		}

		/// <summary>This allows you to spawn a prefab via GameObject.</summary>
		public static GameObject Spawn(GameObject prefab, Vector3 position, Quaternion rotation, Transform parent = null, Transform parentOfPoolPrefab = null)
		{
			if (prefab == null) { Debug.LogError("Attempting to spawn a null prefab."); return null; }
			if (parent != null)
			{
			...
			return Spawn(prefab, position, rotation, prefab.transform.localScale, parent, false, parentOfPoolPrefab);
		}

		/// <summary>This allows you to spawn a prefab via GameObject.</summary>
		public static GameObject Spawn(GameObject prefab, Transform parentOfPoolPrefab = null)
		{
			if (prefab == null) { Debug.LogError("Attempting to spawn a null prefab."); return null; }
			var transform = prefab.transform;
			return Spawn(prefab, transform.localPosition, transform.localRotation, transform.localScale, null, false, parentOfPoolPrefab);
		}

		/// <summary>This allows you to spawn a prefab via GameObject.</summary>
		private static GameObject Spawn(GameObject prefab, Vector3 localPosition, Quaternion localRotation, Vector3 localScale, Transform parent, bool worldPositionStays, Transform parentOfPoolPrefab = null)
		{
			if (prefab != null)
			{
				...
				if (LeanGameObjectPool.TryFindPoolByPrefab(prefab, ref pool) == false)
				{
					...
					pool.Prefab = prefab;
					if(parentOfPoolPrefab != null){
                        pool.transform.SetParent(parentOfPoolPrefab);
